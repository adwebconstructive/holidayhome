        ...
        <div class="row">
            ...
            <div class="col-md-4 py-2">
                ...
                <div class="modal fade" id="imageModal{{$room->id}}" tabindex="-1" role="dialog" aria-labelledby="imageModal{{$room->id}}Label" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            {!! Form::model($room, ['url' => route('hotel.room.image', ['id' => $hotel->id, 'room_id' => $room->id]), 'files' => true])
                            !!}
                            <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLabel">Upload images for room no: {{ $room->room_number }}</h5>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                </button>
                            </div>
