                    ...
                    <div class="card">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <img src="{{ $image->image_path }}" alt="Hotel image">
                                        </div>
                                        @endforeach
                                    </div>
                                </div>
                        ...
                        <div class="card-footer text-right">
                            <button class="btn btn-primary" data-toggle="modal" data-target="#createModal">Create
                                Room</button>
                            <button class="btn btn-success" data-toggle="modal" data-target="#uploadHotelImagesModal">Upload Image</button>
                            <div class="modal fade" id="uploadHotelImagesModal" tabindex="-1" role="dialog"
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        {!! Form::open(['url' => route('hotel.image', ['id' => $hotel->id]), 'files' => true])!!}
