        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="card-tools"> <form action="{{route('hotels.index')}}" method="get">
                            ...
                            <td>
                                <div class="btn-group btn-group-sm">
                                   ...
                                   <a href="{{url('admin/hotel-add-more',$hotel->id)}}" class="btn btn-primary">
                                    ...
                                    <button type="button" class="btn btn-info" data-toggle="modal" data-target="#modal-edit{{$hotel->id}}">
...
{{--                                        <button type="button" class="btn btn-default " data-dismiss="modal">Close</button>--}}
                        ...
                        {{--end delete model--}}
                        <div class="modal fade" id="modal-edit{{$hotel->id}}">
                    ...
                    <div class="modal-body">
                        <form  method="post" action="{{route('hotels.store')}}" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    <label for="pin_code">Pin</label>
                                    <input type="number" name="pin_code" class="form-control" id="pin_code" placeholder="Pin Code" required>
                                </div>
                                <div class="form-group">
                                    <label for="gstn">GSTN</label>
                                ...
                                <div class="form-group">
                                    <label for="contact_phone">Contact Phone</label>
                                    <input type="number" maxlength="10" name="contact_phone" class="form-control" id="contact_phone" placeholder="Contact Phone" required>
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputFile">Logo</label>
                                    <div class="input-group">
